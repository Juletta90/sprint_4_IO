...
# Создадим объект класса Queue и наполним его элементами:
# команды учёных уже наперебой отправляют задания, добавим их в очередь.
...
# Ровер извлекает элемент из очереди и приступает к выполнению:
item = queue.pop()